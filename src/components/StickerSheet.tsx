...
const StickerSheet: React.FC<StickerSheetProps> = ({ 
  ...
  return (
    <div 
      ref={sheetRef} 
      className="sticker-sheet grid grid-cols-2 gap-0 relative w-[210mm] h-[297mm] p-4 m-0 print:m-0 print:p-4 kids-theme-bg print:kids-theme-bg"
    >
      ...
      {verses.map((verse, index) => {
        ...
        return (
          <div key={`${verse.reference}-${index}`} className="relative h-[36mm] sticker-container">
